...
int exec() {
  ...
  static const void* jumpTable[16] = {&&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7,
    &&L8, &&L9, &&LA, &&LB, &&LC, &&LD, &&LE, &&LF};

  static const void* jumpTable2[16] = {&&LL0, &&LL1, &&LL2, &&LL3, &&LL4, &&LL5, &&LL6, &&LL7,
    &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&LLF};
